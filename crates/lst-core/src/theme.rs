...
impl Theme {
    ...
    pub fn generate_css_variables(&self) -> String {
        ...
        if let Some(ref color) = self.palette.base00 { css.push_str(&format!("  --color-base00: {};\n", color)); }
        if let Some(ref color) = self.palette.base01 { css.push_str(&format!("  --color-base01: {};\n", color)); }
        if let Some(ref color) = self.palette.base02 { css.push_str(&format!("  --color-base02: {};\n", color)); }
        if let Some(ref color) = self.palette.base03 { css.push_str(&format!("  --color-base03: {};\n", color)); }
        if let Some(ref color) = self.palette.base04 { css.push_str(&format!("  --color-base04: {};\n", color)); }
        if let Some(ref color) = self.palette.base05 { css.push_str(&format!("  --color-base05: {};\n", color)); }
        if let Some(ref color) = self.palette.base06 { css.push_str(&format!("  --color-base06: {};\n", color)); }
        if let Some(ref color) = self.palette.base07 { css.push_str(&format!("  --color-base07: {};\n", color)); }
        if let Some(ref color) = self.palette.base08 { css.push_str(&format!("  --color-base08: {};\n", color)); }
        if let Some(ref color) = self.palette.base09 { css.push_str(&format!("  --color-base09: {};\n", color)); }
        if let Some(ref color) = self.palette.base0a { css.push_str(&format!("  --color-base0A: {};\n", color)); }
        if let Some(ref color) = self.palette.base0b { css.push_str(&format!("  --color-base0B: {};\n", color)); }
        if let Some(ref color) = self.palette.base0c { css.push_str(&format!("  --color-base0C: {};\n", color)); }
        if let Some(ref color) = self.palette.base0d { css.push_str(&format!("  --color-base0D: {};\n", color)); }
        if let Some(ref color) = self.palette.base0e { css.push_str(&format!("  --color-base0E: {};\n", color)); }
        if let Some(ref color) = self.palette.base0f { css.push_str(&format!("  --color-base0F: {};\n", color)); }
        
        // Base24 colors if present
        if let Some(ref color) = self.palette.base10 { css.push_str(&format!("  --color-base10: {};\n", color)); }
        if let Some(ref color) = self.palette.base11 { css.push_str(&format!("  --color-base11: {};\n", color)); }
        if let Some(ref color) = self.palette.base12 { css.push_str(&format!("  --color-base12: {};\n", color)); }
        if let Some(ref color) = self.palette.base13 { css.push_str(&format!("  --color-base13: {};\n", color)); }
        if let Some(ref color) = self.palette.base14 { css.push_str(&format!("  --color-base14: {};\n", color)); }
        if let Some(ref color) = self.palette.base15 { css.push_str(&format!("  --color-base15: {};\n", color)); }
        if let Some(ref color) = self.palette.base16 { css.push_str(&format!("  --color-base16: {};\n", color)); }
        if let Some(ref color) = self.palette.base17 { css.push_str(&format!("  --color-base17: {};\n", color)); }
        
        css.push_str("\n  /* Semantic Color Mappings */\n");
        
        // Generate semantic variables by resolving base color references
        css.push_str(&format!("  --color-background: var(--color-{});\n", self.semantic.background));
        css.push_str(&format!("  --color-foreground: var(--color-{});\n", self.semantic.foreground));
        css.push_str(&format!("  --color-primary: var(--color-{});\n", self.semantic.primary));
        css.push_str(&format!("  --color-secondary: var(--color-{});\n", self.semantic.secondary));
        css.push_str(&format!("  --color-accent: var(--color-{});\n", self.semantic.accent));
        css.push_str(&format!("  --color-muted: var(--color-{});\n", self.semantic.muted));
        css.push_str(&format!("  --color-border: var(--color-{});\n", self.semantic.border));
        css.push_str(&format!("  --color-success: var(--color-{});\n", self.semantic.success));
        css.push_str(&format!("  --color-warning: var(--color-{});\n", self.semantic.warning));
        css.push_str(&format!("  --color-error: var(--color-{});\n", self.semantic.error));
        css.push_str(&format!("  --color-info: var(--color-{});\n", self.semantic.info));
        
        css.push_str("\n  /* Legacy Compatibility */\n");
        // Map to existing CSS variables for backwards compatibility
        css.push_str(&format!("  --background: var(--color-{});\n", self.semantic.background));
        css.push_str(&format!("  --foreground: var(--color-{});\n", self.semantic.foreground));
        css.push_str(&format!("  --primary: var(--color-{});\n", self.semantic.primary));
        css.push_str(&format!("  --accent: var(--color-{});\n", self.semantic.accent));
        css.push_str(&format!("  --muted: var(--color-{});\n", self.semantic.muted));
        css.push_str(&format!("  --border: var(--color-{});\n", self.semantic.border));
        
        // Additional mappings for existing variables
        css.push_str(&format!("  --card: var(--color-{});\n", self.semantic.muted));
        css.push_str(&format!("  --card-foreground: var(--color-{});\n", self.semantic.foreground));
        css.push_str(&format!("  --popover: var(--color-{});\n", self.semantic.background));
        css.push_str(&format!("  --popover-foreground: var(--color-{});\n", self.semantic.foreground));
        css.push_str(&format!("  --primary-foreground: var(--color-{});\n", self.semantic.background));
        css.push_str(&format!("  --secondary: var(--color-{});\n", self.semantic.secondary));
        css.push_str(&format!("  --secondary-foreground: var(--color-{});\n", self.semantic.foreground));
        css.push_str(&format!("  --muted-foreground: var(--color-{});\n", self.semantic.muted));
        css.push_str(&format!("  --accent-foreground: var(--color-{});\n", self.semantic.background));
        css.push_str(&format!("  --destructive: var(--color-{});\n", self.semantic.error));
        css.push_str(&format!("  --input: var(--color-{});\n", self.semantic.border));
        css.push_str(&format!("  --ring: var(--color-{});\n", self.semantic.primary));
...
impl ThemeLoader {
    ...
    fn merge_themes(&self, mut parent: Theme, child: Theme) -> Result<Theme> {
        ...
        if let Some(base00) = child.palette.base00 { parent.palette.base00 = Some(base00); }
        if let Some(base01) = child.palette.base01 { parent.palette.base01 = Some(base01); }
        if let Some(base02) = child.palette.base02 { parent.palette.base02 = Some(base02); }
        if let Some(base03) = child.palette.base03 { parent.palette.base03 = Some(base03); }
        if let Some(base04) = child.palette.base04 { parent.palette.base04 = Some(base04); }
        if let Some(base05) = child.palette.base05 { parent.palette.base05 = Some(base05); }
        if let Some(base06) = child.palette.base06 { parent.palette.base06 = Some(base06); }
        if let Some(base07) = child.palette.base07 { parent.palette.base07 = Some(base07); }
        if let Some(base08) = child.palette.base08 { parent.palette.base08 = Some(base08); }
        if let Some(base09) = child.palette.base09 { parent.palette.base09 = Some(base09); }
        if let Some(base0a) = child.palette.base0a { parent.palette.base0a = Some(base0a); }
        if let Some(base0b) = child.palette.base0b { parent.palette.base0b = Some(base0b); }
        if let Some(base0c) = child.palette.base0c { parent.palette.base0c = Some(base0c); }
        if let Some(base0d) = child.palette.base0d { parent.palette.base0d = Some(base0d); }
        if let Some(base0e) = child.palette.base0e { parent.palette.base0e = Some(base0e); }
        if let Some(base0f) = child.palette.base0f { parent.palette.base0f = Some(base0f); }
        
        // Base24 colors
        if let Some(base10) = child.palette.base10 { parent.palette.base10 = Some(base10); }
        if let Some(base11) = child.palette.base11 { parent.palette.base11 = Some(base11); }
        if let Some(base12) = child.palette.base12 { parent.palette.base12 = Some(base12); }
        if let Some(base13) = child.palette.base13 { parent.palette.base13 = Some(base13); }
        if let Some(base14) = child.palette.base14 { parent.palette.base14 = Some(base14); }
        if let Some(base15) = child.palette.base15 { parent.palette.base15 = Some(base15); }
        if let Some(base16) = child.palette.base16 { parent.palette.base16 = Some(base16); }
        if let Some(base17) = child.palette.base17 { parent.palette.base17 = Some(base17); }
        
        // Override other fields from child
        parent.scheme = child.scheme;
        parent.system = child.system;
        if child.name.is_some() { parent.name = child.name; }
        if child.author.is_some() { parent.author = child.author; }
        if child.description.is_some() { parent.description = child.description; }
        if child.variant.is_some() { parent.variant = child.variant; }
        if child.variants.is_some() { parent.variants = child.variants; }
        if child.overrides.is_some() { parent.overrides = child.overrides; }
    ...
    fn load_built_in_themes(&mut self) {
        // Base16 Default Dark
        self.built_in_themes.insert("base16-default-dark".to_string(), Theme {
            system: ThemeSystem::Base16,
            scheme: "base16-default-dark".to_string(),
        ...
        self.built_in_themes.insert("base16-default-light".to_string(), Theme {
            system: ThemeSystem::Base16,
...
fn default_background() -> String { "base00".to_string() }
fn default_foreground() -> String { "base05".to_string() }
fn default_primary() -> String { "base0D".to_string() }
fn default_secondary() -> String { "base06".to_string() }
fn default_accent() -> String { "base0E".to_string() }
fn default_muted() -> String { "base03".to_string() }
fn default_border() -> String { "base02".to_string() }
fn default_success() -> String { "base0B".to_string() }
fn default_warning() -> String { "base0A".to_string() }
fn default_error() -> String { "base08".to_string() }
fn default_info() -> String { "base0C".to_string() }
...
mod tests {
    ...
    fn test_color_resolution() {
        ...
        assert_eq!(theme.resolve_base_color("base05"), Some("#cdd6f4".to_string()));
        
        // Test semantic color resolution
        assert_eq!(theme.resolve_semantic_color("background"), Some("#1e1e2e".to_string()));
        assert_eq!(theme.resolve_semantic_color("foreground"), Some("#cdd6f4".to_string()));
    }
}